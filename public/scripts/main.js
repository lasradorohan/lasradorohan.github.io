...
(function ($) {
    ...
    $("#fun-fact-select").on("click",function (){
        const idx = Math.floor(Math.random() * funFacts.length);
        const randomFact = funFacts[idx];
    ...
    $(animationElement).on("click", function() {
    ...
    $(".r-project-show").on("click", function () {
        $("#r-project-view-" + $(this).attr("target")).css("display", "block")
    })
    $(".r-project-close").on("click", function () {
